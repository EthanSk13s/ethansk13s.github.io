...
<template>
  <header>
    <div class="bg-ctp-surface0 flex flex-col flex-wrap gap-2 justify-self-center md:flex-row md:justify-evenly
                 text-center md:gap-52 p-4 border border-ctp-mantle">
